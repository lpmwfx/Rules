---
tags: [states, state-files, constants, enums, no-hardcoding, zero-literals, slintscanners, create-before-use]
...
related: [slint/component-model.md, global/config-driven.md, uiux/state-flow.md, slint/init.md, uiux/tokens.md]
